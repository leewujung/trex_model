...
saveSameSize_100(fig_2d_lin,'file',fullfile(save_path,save_name_lin),...
    'format','png','renderer','painters');
saveSameSize_100(fig_2d_log,'file',fullfile(save_path,save_name_log),...
    'format','png','renderer','painters');
