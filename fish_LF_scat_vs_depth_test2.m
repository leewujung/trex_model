...
[f0,sigma_bs,Vz] = swb_LF_fbs(xi,D,freq,'nero',swb_shape,param);
plot(freq,10*log10(sigma_bs));
hold on

[f0,sigma_bs,Vz] = swb_LF_model_test2(xi,D,freq,'ye',swb_shape,param);
plot(freq,10*log10(sigma_bs));
hold on

[f0,sigma_bs,Vz] = swb_LF_model_test2(xi,D,freq,'chu',swb_shape,param);
plot(freq,10*log10(sigma_bs));
